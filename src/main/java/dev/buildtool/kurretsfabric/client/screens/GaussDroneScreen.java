...
public class GaussDroneScreen extends InventoryScreen<GaussDroneScreenHandler> {
    public GaussDroneScreen(GaussDroneScreenHandler screenHandler, PlayerInventory playerInventory, Text text) {
